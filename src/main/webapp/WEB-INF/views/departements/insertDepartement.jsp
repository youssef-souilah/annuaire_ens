...
<body>
  ...
  <div class=" overflow-x-auto w-full">
    ...
    <h1 class="font-semibold text-xl text-blue-500">Departements</h1>
          ...
          <div class="p-1.5 min-w-full inline-block align-middle">
            <div class="border rounded-lg divide-y divide-gray-200"> 
              <div class="py-3 px-4 w-full flex flex-row item-center justify-between   ">
                ...
                <form action="departements" class="relative max-w-xs  flex items-center " method="get">
              ...
              <div class="overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="divide-y divide-gray-200">
                  	<c:forEach var="departement" items="${requestScope.list}">
	                  	<tr>
